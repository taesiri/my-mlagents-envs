...
namespace UnityEngine.Recorder.Examples
{
    ...
    public class CaptureScreenShotExample : MonoBehaviour
    {
       ...
       void OnEnable()
       {
           ...
           var mediaOutputFolder =  "C:\\Workspace\\screenshots\\";//Path.Combine(Application.dataPath, "..", "SampleRecordings");
           ...
           imageRecorder.OutputFile = mediaOutputFolder +  "image_" + DefaultWildcard.Take;
