...
public class DudeAgent : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (doRandomThings)
        {
            ...
            // {
            //     _motor1.motorSpeed = 50f * Input.GetAxis("Vertical");
            //     _hip1Joint.motor = _motor1;
            //     _motor2.motorSpeed = 50f * Input.GetAxis("Horizontal");
            //     _hip2Joint.motor = _motor2;
            // }
            // else
            // {
            //     _motor3.motorSpeed = 50f * Input.GetAxis("Vertical");
            //     _leg1Joint.motor = _motor3;
            //     Debug.Log(_motor3.motorSpeed);
            //     _motor4.motorSpeed = 50f * Input.GetAxis("Horizontal");
            //     _leg2Joint.motor = _motor4;
            //     Debug.Log(_motor4.motorSpeed);
            // }


             _motor1.motorSpeed = 200f * Input.GetAxis("Vertical");
            _hip1Joint.motor = _motor1;
            _motor2.motorSpeed = 200f * Input.GetAxis("Horizontal");
            _hip2Joint.motor = _motor2;
