...
public class Ball3DAgent : Agent
{
    ...
    public List<Rigidbody> initialRBodies = new List<Rigidbody>();
    ...
    private void Awake()
    {
        ...
        {
            initialPositions.Add(initialStates[i].position);
            initialRotations.Add(initialStates[i].rotation);
        }
    }
    ...
    public override void AgentReset()
    {
        ...
        for (int i = 0; i < initialStates.Count; i++)
        {
            ...
            initialStates[i].position = initialPositions[i];
            initialStates[i].rotation = initialRotations[i];

        }

        foreach (var rb in initialRBodies)
        {
